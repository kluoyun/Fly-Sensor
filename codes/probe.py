...
class PrinterProbe:
    ...
    def _probe(self, speed):
        ...
        fly_probe = self.printer.lookup_object("fly_probe")  ##fly
        ...
        if fly_probe.probe_mode == 1:  ##fly
            epos = pos  ##fly
            bed_mesh = self.printer.lookup_object("bed_mesh")  ##fly
            toolhead.wait_moves()  ##fly
            try:
                epos[2] = bed_mesh.horizontal_move_z - fly_probe.get_probe_va()  ##fly

            except self.printer.command_error as e:  ##fly
                print(e)  ##fly
        else:  ##fly
            try:
    ...
    def run_probe(self, gcmd):
        ...
        fly_probe = self.printer.lookup_object("fly_probe")  ##
        retries = 0
        positions = []
